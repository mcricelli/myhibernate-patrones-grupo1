...
select p.id_producto,p.descripcion_producto,c.id_categoria,c.descripcion_categoria
...
CREATE TABLE tipo_cliente (
           ...
           ,descripcion_tipo_cliente VARCHAR(255));
...
INSERT INTO orden VALUES (1, 1, 5, date_sub(now,15 day), date_sub(now,10 day));
...
INSERT INTO detalle_orden VALUES (1, 1, 3, 5);
...
select descripcion_producto from producto
where id_producto=1;

select prod.descripcion_producto,prov.empresa, prov.direccion_proveedor
